...
module.exports = function(controller) {
    ...
    controller.hears([new RegExp(/((?<!not )pizza)/i)], 'ambient,mention', function(bot, message) {
      const pizzas = [
        ...
        'https://media.giphy.com/media/MlH680EXVnUQg/giphy.gif',
        'https://media.giphy.com/media/3oEduXWSTEroC5U7aE/200w_d.gif',
    ...
    controller.hears(['solve the problem','big problems', 'racist','racism', 'police brutality'], 'direct_message,direct_mention,ambient', function(bot, message) {
      if (!!message.match[0]) {
        bot.reply(message,':problem_solved:');
      }
    });
